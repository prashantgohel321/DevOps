# Git Level 3, Task 3: Rewriting History with `git reset --hard`
...
## Table of Contents
- [Git Level 3, Task 3: Rewriting History with `git reset --hard`](#git-level-3-task-3-rewriting-history-with-git-reset---hard)
...
3.  This action should remove all subsequent commits from the history, leaving only two commits.

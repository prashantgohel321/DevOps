# Git Level 3, Task 2: Mastering the Pull Request Workflow
...
## Table of Contents
- [Git Level 3, Task 2: Mastering the Pull Request Workflow](#git-level-3-task-2-mastering-the-pull-request-workflow)
...
<a name="why-did-i-do-this-the-what--why-of-pull-requests)"></a>
...
[Image of the Pull Request workflow diagram]
...
-   **`Review` Button**: The button (in my case, on the "Files Changed" tab) that opens the dialog for a formal approval.
